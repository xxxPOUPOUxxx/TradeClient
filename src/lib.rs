...
#[derive(Debug)]
pub struct TradeClientProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TradeClientProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TradeClient processing");
    
    let mut processor = TradeClientProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TradeClientProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TradeClientProcessor::new(false);
